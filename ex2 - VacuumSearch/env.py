...
class State:
    def __init__(self, foodGrid, chance_map, consume_tile=False, turningCost=0, foodAddScore=1, foodScoreMulti=2, winScore=30):
    ...
    def __eq__(self, obj):
        return isinstance(obj, State) and \
            ...
            obj.maxFoodScore == self.maxFoodScore and \
    ...
    def __deepcopy__(self, memo):
        ...
        if _copy is None:
            ...
            _copy.maxFoodScore = self.maxFoodScore
